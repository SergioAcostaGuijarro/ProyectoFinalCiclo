  ...
  <main class="admin__main">
    <div class="dashboard">
      <div class="dashboard__item dashboard__item--full">
        <div class="card">
        <h5>Modificar materia</h5>
        <form action="actualizarm2.php" method="POST">
        <div class="izq">
            <h6>Id: </h6>
         ...
         <div class="cen">
          ...
          <input type="submit" value="Modificar" name="añadir"  class="btn  btn--primary">
         </div>
        </form>
            </form>
            <?php
                ...
                for ($i = 0; $i < $nfilas; $i++) {
                    ...
                    print("<TD>" . $resultado['id_profesor'] . "</TD>\n");
