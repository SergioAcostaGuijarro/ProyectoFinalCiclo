    ...
    <div class="dashboard">
      <div class="dashboard__item dashboard__item--full">
        ...
        <h5>Eliminar un trabajador</h5>
         <form action="eliminara2.php" method="post">
            <input type="varchar" placeholder="ID..." name="id">
            <input type="Submit" value="Eliminar" name="entrar" class="btn  btn--primary">
         </form>
        <?PHP
         ...
         $instruccion = "select * from usuario where tipo_usuario='profesor'";
