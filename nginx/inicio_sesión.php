...
<body>
    ...
    <main>
        <article>
                ...
                <hr>
                    <form action="inicio_sesión2.php" method="get">
                        <div class="inputsini">
                ...
                <pre><a href="registrarse.php">¿No tienes cuenta?, registrate</a><a href="recuperar.php">     He olvidado mi contraseña</a></pre>
                <br><hr>    
        </article>
    </main>
    <footer>
