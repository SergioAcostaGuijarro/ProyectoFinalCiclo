	...
	<main class="admin__main">
		...
		<div class="dashboard__item">
			...
			<?php
				...
				$instruccion2 = "SELECT * FROM curso";
				...
				if ($nfilas > 0) {
					...
					while ($resultado = mysqli_fetch_array($consulta)) {
						...
						print("<TD><a href='calificaciones2.php?curso=" . urlencode($resultado['curso']) . "'><button id='boton_" . $resultado['id_curso'] . "' title='Notas' onclick='mostrarMenu(" . $resultado['id_curso'] . ")'><img src='./img/acceso.png' width='35%'></button></a></TD>\n");
						print("</TR>\n");
					}
					print("</TABLE>\n");
				} else {
					print("No hay cursos disponibles para este profesor.");
				}
