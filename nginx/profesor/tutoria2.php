    ...
    <body>
		...
		<main class="admin__main">
			...
			<div class="dashboard__item">
				<div class="card">
					<form action="tutoria3.php" method="post">
                    <?php
                        ...
                        $instruccion2 = "SELECT nombre, correo, curso.curso, id_usuario FROM alumno, curso WHERE tutor = '$_SESSION[nombre]' AND alumno.id_curso=curso.id_curso";
                        ...
                        if ($nfilas > 0) {
                            ...
                            while ($resultado = mysqli_fetch_array($consulta)) {
								...
								print("<form action='tutoria3.php' method='post'>\n");
								print("<TD><input type='hidden' name='id_alumno' value='" . $resultado['id_usuario'] . "'><input type='submit' value='Mostrar' name='mostrar' class='btn btn--primary'></TD>\n");
								print("</form>\n");                                
								print("</TR>\n");
                            }
                            print("</TABLE>\n");
                        } else {
                            print("No tiene ningun alumno en esta tutoría.");
                        }
